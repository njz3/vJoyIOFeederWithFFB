...
// Mega Adapter "Non-Neo" pinout for lamp outputs
int DOutLCoin1Pin       = A8; // digital output -> COIN METER 1
int DOutLCoin2Pin       = A15; // digital output -> UNUSED
int DOutLStartPin       = A14; // digital output -> START
int DOutLView1Pin       = A13; // digital output -> VR1
int DOutLView2Pin       = A12; // digital output -> VR2
int DOutLView3Pin       = A11; // digital output -> VR3
int DOutLView4Pin       = A10; // digital output -> VR4
int DOutLLeaderPin      = A9; // digital output -> LEADER
#endif

// Mega Adapter "Non-Neo" pinout for buttons
int DInBtn1Pin          = D4; // digital input -> COIN1
int DInBtn2Pin          = D2; // digital input -> TEST
int DInBtn3Pin          = D3; // digital input -> SERVICE
int DInBtn4Pin          = D5; // digital input -> START

int DInBtn5Pin          = D6; // digital input -> VR1
int DInBtn6Pin          = D7; // digital input -> VR2
int DInBtn7Pin          = D8; // digital input -> VR3
int DInBtn8Pin          = D12; // digital input -> VR4
...
int DInBtn9Pin          = D39; // digital input - for H4 encode up row engaged -> shift0
int DInBtn10Pin         = D38; // digital input - for H4 encode down row engaged -> shift1
int DInBtn11Pin         = D40; // digital input - for H4 encode "left" column engaged -> shift2
